...
export const candidatesData: Candidate[] = [
  {
    id: '1',
    name: 'Sarah Miller',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBBhDq3a9HA0YW7vH8RLY3QmlKkIWphHqM-C7FcPUNi6UGch1IzdFHHfrQpTOHS6_maS4I6gnCsIK7g7CJ2DvD4Yz8QcAzeDvtzVJFEpR3QheEJvOK1N1oZ41Fs1hs2I8wJE1lOpX_ilgfKrOdcnGIT8Kx--2L65jLbrOpgRmslVcquGReN5mQnRetWNWxyMUnW_WRoyjw94gDIUgGBKrDmMEdcFT6XQpLYjFMQbJQ14sZIILoC-VS7AaqSDdoh_8ASGfvRbmyfwt6t',
  ...
  },
  {
    id: '3',
    name: 'Chloe Chen',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAssyAzSM_Hk7bVFDybj8IYNxy04JwnXmGYqLgYO5CBV1oERs67ZUCMYwlXxGAYqfWEst8MxWCQSA16r5h1NdQbqKljS_sY150q_9iwtHJyfldeIZAgqt11InHfWeLxRJNIk5WVjerIvOG8cK7Su58XOjvjF7ZFJcJwRUht9UA238hf-1mGh69dwYuD0Sywls95OEtVVJ5AXqFVMmJWzPGc1rAiVey6GfxM7MUvzkMD3N5F_WghJt3IRbuV9ro_v-psHmx-1eqUe2H4',
  ...
  },
  {
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCLau3FeodBE7gxlqbvwtM53RiS_jzr4FbOryTnKZdfheGY_8BJ_TZOytXVqtb6cYsc4goUmrmpx9O2ZmtGVD6qUMBO4l0RhTKyfewtMVPKcLvXhZnhE4kCJTh45dWv5gY3KNXDXx4SLVHNYgHhgI48UEZAHpQeeb-ketwwfdz7jGby3GhIhh4mmS1w_URgH_deMgftj-skADeZXLSCijHkVKmPH9xpKAgEbrijpPgHjUfKTSFbRVS1cE4chLYfuHbcGyah1SXZbSNu',
  ...
  },
  {
    id: '5',
    name: 'Isabella Gray',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBcrCwLOmYlwlb0GyAFECt-NlHDVsegAl9uwCFiqAheumABAYzsNLOPNhUfdzBidtbdzGFB1NzHdd9YsXhb-fWeY-HDZJeCB0s7SlMxWexWW2AlxAcWRubwDPnwmFftqdI4vlpix7RIREIQyjRyzPGLEWjioxruU9-fl9BSxbsyBEBom8UYLsCPvirKRxroUoqzL251cQEZAn6tSkrvFnQF8EDYVKsPNk0P62ylg64Qjrouli9o60u7o7iDGqGZVViI_UYESYogwkLt',
    ...
    id: '6',
    name: 'Maya Thompson',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAFBkQNVnNemmHLDAzBmhp_ec_RLTNAlhNFx8-G5pxx5dlNE9WI_x9D_1Zb3QFBusooNnTMhoFTLF3EFUYD5jEs8OqkyIDkZsIc21_vCaB6CR-kNVt5yDWyR2LIvHCMDUczBcdYSuAFhz6P2RWow2Jx-ckwWPrwxa-eY8n62hGe5XGNxa3haouYeIakmHlGBWczVFXMN04jXo9GDElGHibbg37Gcy91pektvYIDzzLjnOKBg_8lc0XCe6SAwXHP_XgIVK0c5xL1vCvh',
  ...
  },
   {
    id: '8',
    name: 'Clara Mendez',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCSKhUdXLWeMS2yUrVG2qdiJwZdJ1bSL3qNw4L-LdWInnBBs3WFKyJwFlI0BGrA7S-Yhi6wr0Mdh2k0UXolqDtGlI2y1B04MTKMlEhaByXYequR6w84rP7CtY2vXX5jo1A1qzJrAfwJOMlKUAd8uyHc3UngtEbHdLZWqtVo217gvyOOuOl1o8hxOJzrlr_T4MO3f-m-JvEyblbYKT9mznfdTxrwhS4bRMURPVOZ8qjNcCYoICXb_Ux-8gYHzjg7FPaUNqaes_k4OWt4',
...
const HomePage: React.FC = () => {
  ...
  return (
    <Home
      ...
      candidates={candidatesData.slice(0, 4)}
    />
  );
};
...
const ProfilePage: React.FC = () => {
  const { id } = useParams();
  const candidate = candidatesData.find((entry) => entry.id === id) || candidatesData[1];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <Routes>
        ...
        <Route path="/candidates" element={<GalleryPage />} />
